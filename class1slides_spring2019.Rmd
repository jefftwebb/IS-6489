...
- **This is a graduate level course in applied statistics using R**.
...
- You will learn how to: 
    ...
    + Communicate and explain your results to non-experts.
...
- However,  this will be a hybrid course, with some lecture material available online, to be watched before class.  Our nightly schedule will usually go from 6 - 8:30 PM or so.  Tonight we will go longer.
...
- Earlier we discussed the `mtcars` dataset and a simple regression model:  `mpg ~ cyl + hp + wt`.
...
- Instead, the learning is *unsupervised*: we do the best we can, using  algorithms like k-means clustering or hierarchical clustering, to find structure in the data.
